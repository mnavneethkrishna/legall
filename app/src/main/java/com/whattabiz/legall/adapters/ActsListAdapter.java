...
public class ActsListAdapter extends RecyclerView.Adapter<ActsListAdapter.MyViewHolder> {
    ...
    public ActsListAdapter(List<ActsListModel> ActsList) {
       ...
       /* holder.caption.setText(bulletText.getType());
        ...
        holder.main_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                intent.putExtra("LIST_ID", bulletText.getId());
                intent.putExtra("LINK_ID", bulletText.getLink());
