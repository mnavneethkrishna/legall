...
import com.whattabiz.legall.activity.LitigationSubCatActivity;
...
public class LitigationMainCatAdapter extends RecyclerView.Adapter<LitigationMainCatAdapter.MyViewHolder> {
    ...
    public LitigationMainCatAdapter(List<LitigationCategoryModel> litigationCategoryModelList) {
        ...
        holder.main_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
               ...
               // v.getContext().startActivity(intent);
                Intent i = new Intent(v.getContext(),LitigationSubCatActivity.class);
                i.putExtra("WINDOW_TITLE",categoryModel.getTitle());
                i.putExtra("LINK_ID",categoryModel.getUrl());
