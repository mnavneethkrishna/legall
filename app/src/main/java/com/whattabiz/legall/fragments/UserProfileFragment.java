...
import com.whattabiz.legall.activity.UserHome;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getContext(),EditProfileActivity.class).putExtra("type",0));
            }
        });

        Bitmap bitmap = ((UserHome) getActivity()).bitmap;

        if (bitmap!=null) {
            propic.setImageBitmap(((UserHome) getActivity()).bitmap);
        }
